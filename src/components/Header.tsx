import BandeiraParana from "../../public/bandeira-parana.svg";
  ...
  return (
    <header className="lg:h-50 w-full lg:flex items-center justify-center  lg:bg-(--degrade) lg:bg-gradient-(--degrade) lg:mb-10">
      <div className="w-full flex flex-col-reverse lg:flex-row items-center justify-evenly">
        <div className="flex flex-col items-center justify-center gap-0 lg:gap-2 h-20 mt-2 lg:mt-0">
        ...
        <img
          src={BandeiraParana}
          alt="imagem da bandeira do parana"
